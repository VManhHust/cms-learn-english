...
public class AdminCmsService {
    ...
    @Transactional(readOnly = true)
    public Page<UserDto> getUsers(int page, int size, String sort, String order, String query) {
        Pageable pageable = PageRequest.of(page, size, toSort(sort, order, "createdAt"));
    ...
    private Sort toSort(String field, String order, String fallback) {
        List<String> allowedFields = List.of("id", "createdAt", "title", "topicName", "email", "displayName");
